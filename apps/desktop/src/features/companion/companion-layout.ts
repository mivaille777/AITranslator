export const companionLayoutClassNames = {
  shell:
    "ait-chat-shell grid h-full min-h-0 overflow-y-auto lg:grid-cols-[220px_minmax(0,1fr)] xl:grid-cols-[240px_minmax(0,1fr)_300px] xl:grid-rows-[minmax(0,1fr)] xl:overflow-hidden",
  historyPanel:
  ...
  chatColumn:
    "order-2 flex min-h-[560px] flex-col bg-white xl:h-full xl:min-h-0 xl:overflow-hidden xl:order-2",
  messageScroller:
    "min-h-0 flex-1 overflow-y-auto overscroll-contain px-6 py-5 lg:px-8 xl:px-10",
  composer:
    "relative z-10 shrink-0 border-t border-slate-100/80 bg-white/96 px-5 py-4 backdrop-blur-xl lg:px-8",
} as const
