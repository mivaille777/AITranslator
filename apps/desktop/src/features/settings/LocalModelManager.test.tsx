...
const embedding = { model_id: "qwen3-embedding-0.6b", display_name: "Qwen3 Embedding 0.6B", repository_id: "Qwen/Embedding", state: "not_installed", installed: false, verified: false, path: "", disk_usage_bytes: 0, error: "" }
...
describe("Local model manager", () => {
  ...
  it("requires a second click before removing installed weights", async () => {
    const installed = { ...embedding, state: "installed", installed: true, verified: true, disk_usage_bytes: 1024 ** 3 }
